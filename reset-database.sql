...
DROP TABLE IF EXISTS blog_articles_categories CASCADE;
DROP TABLE IF EXISTS blog_articles_tags CASCADE;
DROP TABLE IF EXISTS blog_articles_comments CASCADE;
DROP TABLE IF EXISTS blog_article_versions CASCADE;
DROP TABLE IF EXISTS blog_newsletter_subscribers CASCADE;
