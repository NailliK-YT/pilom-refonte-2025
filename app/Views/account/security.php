...
<div class="security-grid">
    ...
    <div class="card">
        ...
        <p class="text-muted" style="font-size: 0.875rem;">Un mot de passe fort contient au moins 8 caractères avec des
            majuscules, minuscules, chiffres et symboles.</p>
        <div class="card-footer">
    ...
    <div class="card <?= isset($twoFactorEnabled) && $twoFactorEnabled ? 'two-fa-enabled' : '' ?>">
        <div class="card-header">
            <h3 class="card-title">
            ...
            <?php if (isset($twoFactorEnabled) && $twoFactorEnabled): ?>
        ...
        <p>
            ...
            En plus de votre mot de passe, vous devrez entrer un code généré par une application d'authentification.
        </p>
        <?php if (isset($twoFactorEnabled) && $twoFactorEnabled): ?>
            <p class="text-muted" style="font-size: 0.875rem;">
                ...
                Activée depuis le <?= isset($twoFactorEnabledAt) ? date('d/m/Y', strtotime($twoFactorEnabledAt)) : 'N/A' ?>
            </p>
            <div class="card-footer">
        ...
        <?php else: ?>
            <div class="card-footer">
                <a href="<?= base_url('account/2fa/setup') ?>" class="btn btn-primary">
