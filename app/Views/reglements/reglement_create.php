...
<div class="container">
    <h1 style="margin-bottom: 2rem;">
        <i class="fas fa-money-bill-wave"></i> Ajouter un règlement
    </h1>
    ...
    <form action="<?= base_url('reglements/store') ?>" method="POST">
        <?= csrf_field() ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <select name="facture_id" class="form-select" required>
                        ...
                        <?php foreach ($factures as $f): ?>
                            <option value="<?= $f['id'] ?>" <?= old('facture_id') == $f['id'] ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_reglement" class="form-control"
                           value="<?= old('date_reglement', date('Y-m-d')) ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="mode_paiement" class="form-select" required>
                        ...
                        <option value="CB"      <?= old('mode_paiement') === 'CB' ? 'selected' : '' ?>>CB</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference" class="form-control"
                           value="<?= old('reference') ?>" placeholder="Ex: Numéro de chèque">
                </div>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> Enregistrer le règlement
            </button>
